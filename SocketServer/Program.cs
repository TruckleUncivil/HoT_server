...
public static  class AsynchronousSocketListener
{
    ...
    public static void ReadCallback(IAsyncResult ar)
    {
       ...
       //Send the  incoming message of to be parsed
                ...
                {
                    MakeARoom(incomingMessage.ConcernedRoomName, incomingMessage.SendingPlayerName);
                }
    ...
    public static Room MakeARoom(string roomName, string masterClient)
    {
        Room room = new Room();
        ...
        player.Name = masterClient;
        room.MasterClient = player;

        room.AddPlayerToRoom(player);

        Console.WriteLine("Server:" + masterClient +  "Made a new Room:" + roomName);
        return room;
